...
/*   Updated: 2020/06/19 00:33:55 by sscottie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		write_sti(t_cw *cor, t_carriage *tmp,
...
static int		len_l_2(t_cw *cor, t_carriage *tmp, char *b2, int *l_2)
{
...
static int		*len_l(t_cw *cor, t_carriage *tmp, char *b2, int *f_err)
{
	int				*l_2;
